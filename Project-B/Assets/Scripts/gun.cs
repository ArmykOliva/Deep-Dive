...
{
    [Header("Gun objects")] public GunType currentGunType;
    ...
    [Header("Gun ammo")] public PlacePoint ammoCanPlacePoint;

    [Header("Gun controller")] public Transform gunAim;
    public Grabbable gunGrabbable;

    [Header("Shooting variables")] public float aimDistance = 15f; //distance where to aim
  ...
  public UnityEvent onStopShooting;
    ...
    void LookAtWithLimits(Transform objectToRotate, Vector3 targetPoint, float angleLimit, float rotationDamping)
    {
        ...
        if (rotationDamping != 0)
            objectToRotate.rotation =
                Quaternion.Slerp(objectToRotate.rotation, finalRotation, Time.deltaTime * rotationDamping);
        else
        ...
        if (currentAmmoCan != null)
        {
            ...
            switch (currentGunType)
            {
                ...
                case GunType.Laser:
                    ...
                    GameObject laserBulletInstance =
                        Instantiate(laserBulletPrefab, currentTip.position, currentTip.rotation);
    ...
    public int getAmmoCount()
    {
        ...
        return currentAmmoCan.currentAmmoCount;
    }
